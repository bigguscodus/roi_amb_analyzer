...
parser.add_argument('-g', '--gene', help="HLA prefix and gene. Example: HLA-A", required=True)
...
parser.add_argument('-r', '--resolution', default='4', required=True, help='Determines the level of detail of the alleles in a result according to nomenclature. Levels are: 1,2,3,4')
args = parser.parse_args()
allele_exons_seqs = hla_parser(data=args.imgt_file, region=args.gene)
